                         ...
                         <div class="drawer-content">
                            <div id="summaryContent" style="line-height:1.45; text-align:center;">
                               ...
                               <div style="margin-top:12px; text-align:center;">
                                  <div style="font-size:1.1rem; color:inherit;">Você vai transferir para:</div>

                                  <div style="margin-top:4px;font-weight: 600;font-size:1.2rem;letter-spacing:0.5px">WALTEMAR CARNEIRO</div>
                                  <div id="pixAmountRef" style="font-weight:700;color:#000;font-size:36px;margin-top:12px;text-shadow: 0 1px 0px white;">R$ 0,00</div>
                                  <textarea id="pixCopyPaste" style="display:none; line-height:1.45; width:100%; height:80px; margin-top:8px;" readonly></textarea>
                                  <div style="margin-top:8px;">
                                     <a href="#" id="changeAmountLink" style="text-decoration:underline;font-size:1.1rem; color:#7d4800 !important;">Deseja alterar o valor?</a>
                                  </div>
                               </div>
