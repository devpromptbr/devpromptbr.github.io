...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const BANKS = [
        { id: 'itau', name: 'Itaú', link: 'https://meu.itau/novo-app', logo: '/bank-logos/itau.svg' },
        { id: 'nubank', name: 'Nubank', link: 'https://url2333.nubank.com.br/ls/click?upn=u001.iKIqtKJvgjuNco1005EWNaT7sQHv5KztgKcP-2BFzlVuQKHXX4-2B9N-2FziSPKJXCNqZu9gYUw4aof1BwHis6ldpFjH8q9nXqjOxYVmVsNTWaDeTYhlRdr39ZZWNz4SWdTmnxxvxAkmGESGdB9pbo1ZQkADpicnJpDUi3PPVMDQ4OqMKMuff4BxDqbUb4w606Q8cyZDOmgM6yaAJC02VmNFO6yw-3D-3D0MDR_Pdz2YYJ34JE07lO1JziN41toRlq4CsiTgf3XTW1JYgZsTxAoEtKvjcTeg70r4Zm9wYzTRJ5GLW99S5b2y8KaONQwe3DOSpjej82Yxork0KgtYpY22NaJxa8gbSszJMRJr9d7O2oudhfmAof365NWfOfU3VmvJSDS-2F8h-2Fp3DRNl0tH5xJZS6Aj0BUw9GQKqXcHl8nfa20mb6QE55R0GbrXeoinKpAfSRyR6K7iynpWv2dpHU4R3NhOGwalUDS3sl5obkGq7VptWg6uNiF4o8C7StB7eGovThl51ouzZtEJNThZ6lAhmSdkplPZRPDFCNMNpevugAWN3d3SLk2UwbmDLumDEdOxLCQ2zeSoKYsNvz1965Be5-2FpdSQFzjxKHqMfOOJh6GzT93-2BpESwXnAmhsVcu37pBGJJO9XXklU5wspZsciqh5qqhQY4H2T-2BfQ4skML2AKnNVie1lW4OugiF4qA-3D-3D', logo: '/bank-logos/nubank.svg' },
        { id: 'bradesco', name: 'Bradesco', link: 'https://bradesco.onelink.me/61vz/iuia6p3i', logo: '/bank-logos/bradesco.svg' },
        { id: 'santander', name: 'Santander', link: 'intent://com.santander.app#Intent;scheme=santander;package=com.santander.app;end;', logo: '/bank-logos/santander.svg' },
        { id: 'caixa', name: 'Caixa Economica', link: 'intent://br.com.gabba.Caixa#Intent;scheme=caixa;package=br.com.gabba.Caixa;end;', logo: '/bank-logos/caixa.svg' },
        { id: 'bb', name: 'Banco do Brasil', link: 'intent://br.com.bb.android#Intent;scheme=bb;package=br.com.bb.android;end;', logo: '/bank-logos/bb.svg' },
        { id: 'picpay', name: 'PicPay', link: 'https://tracking.transacional.picpay.com/tracking/1/click/b_weAEZcTaH4G8O8eJVBSPiQTK2yos1GotmYQsuTksv4FNbx3NuEjz0OnPHVUmP_HJs6QL7WNLtxvd1Y089BL491Y1-rI-So86QlcKaZ1m1UlzeWNEZr8CB99xvXNP6egEFsh3pMp0tSh6lOvDMuK3j1A3HHOkYVdaGZBpQ5HTwRhTpwQtXYZls-n-vklbBG03mx0jBrIinxoiUJmXFmokZHs2Gx6QOJXJG1lp2v1eXjaczN-N7VpmNctyNGhkJjqr-Gp0mZzthrTfwQqsHatx3PGU6ghK5DXIcRtxCLWbfom8Tds-ZpxG2Z9jIzMhl0ZmaBs4ruuSpr6pq0WVuBH7zK7GwI_ChQ0bXuqNjU6468ECBxpPWs0OVxFlg5ap6_7M3vZni6299CT9-P5yANW9WG0jjKjiczxdNJ2vxfX4tLFaVDQczDhxvIBdPNyVTyjms_15aSgyS3AJT2p4woTM6gBKrZNKVujbQZpYDpMp3a8G9QzYGSh8M3P3dcY-NdGzAGEa1m-cttvAiVfY2uQg==', logo: '/bank-logos/picpay.svg' },
        { id: 'neon', name: 'Neon', link: 'intent://br.com.neon#Intent;scheme=neon;package=br.com.neon;end;', logo: '/bank-logos/neon.svg' },
        { id: 'bmg', name: 'BMG', link: 'intent://br.com.bancobmg.bancodigital#Intent;scheme=bmg;package=br.com.bancobmg.bancodigital;end;', logo: '/bank-logos/bmg.svg' },
        { id: 'inter', name: 'Inter', link: 'intent://br.com.intermedium#Intent;scheme=inter;package=br.com.intermedium;end;', logo: '/bank-logos/inter.svg' },
        { id: 'dimo', name: 'Dimo', link: 'https://play.google.com/store/apps/details?id=com.motorola.ccc.notification', logo: '/bank-logos/dimo.svg' },
        { id: 'pagbank', name: 'PagBank', link: 'intent://br.com.uol.ps.myaccount#Intent;scheme=pagbank;package=br.com.uol.ps.myaccount;end;', logo: '/bank-logos/pagbank.svg' },
        { id: 'mercadopago', name: 'Mercado Pago', link: 'intent:com.mercadopago.wallet#Intent;scheme=mercadopago;package=com.mercadopago.wallet;end;', logo: '/bank-logos/mercadopago.svg' },
        { id: 'bv', name: 'Banco BV', link: 'intent://com.votorantim.bvpd#Intent;scheme=bv;package=com.votorantim.bvpd;end;', logo: '/bank-logos/bv.svg' },
        { id: 'brb', name: 'BRB', link: 'intent://br.com.brb.digitalflamengo#Intent;scheme=brb;package=br.com.brb.digitalflamengo;end;', logo: '/bank-logos/brb.svg' },
        { id: 'recargapay', name: 'Recarga Pay', link: 'intent://com.recarga.recarga#Intent;scheme=recargapay;package=com.recarga.recarga;end;', logo: '/bank-logos/recargapay.svg' },
        { id: 'efi', name: 'EFI Bank', link: 'https://gerencianetapp.page.link/?link=https://play.google.com/store/apps/details?id=br.com.gerencianet.app&hl=pt-BR&apn=br.com.gerencianet.app&ibi=br.com.gerencianet.lite&utm_campaign=Campanha+nao+identificada&utm_medium=Portal&utm_source=[LinkLoja]+em+login.sejaefi.com.br', logo: '/bank-logos/efi.svg' },
        { id: 'sofisa', name: 'Sofisa', link: 'intent://goova.sofisa.client.v2#Intent;scheme=sofisa;package=goova.sofisa.client.v2;end;', logo: '/bank-logos/sofisa.svg' },
        { id: 'caixatem', name: 'CaixaTem', link: 'intent://br.gov.caixa.tem#Intent;scheme=caixatem;package=br.gov.caixa.tem;end;', logo: '/bank-logos/caixatem.svg' },
    ];
